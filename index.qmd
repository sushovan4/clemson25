...
```{ojs}
{
  ...
  svg
    ...
    svg.append("path")
        .attr("class", "arc")
        .attr("d", arc)
        .attr("fill", rad <= 0.25 ? "#3be57f" : "rgb(226, 19, 19)");
...
- For Euclidean shapes, **geometric reconstruction** using *Shadow Complexes* (Rafal Komendarczyk & Atish Mitra)
