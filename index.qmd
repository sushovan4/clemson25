...
subtitle: <green>58th Spring Topology and Dynamics Conference, 2025</green>
...
## Today's Agenda
- The topology of Vietoris--Rips Complexes
- Hausmann's Curious Question
- The Finite Reconstruction Problem
...
# The Vietoris--Rips Complexes {.smaller background-image="drawing.png" background-opacity="0.3"}
...
## The Topology of $\mathcal{R}_\beta(X)$
...
## Finite Reconstruction Problem and Hausmann's Curious Question  {.smaller}
