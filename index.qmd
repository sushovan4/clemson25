...
::: {.column width="40%"}
![](gh.png){fig-align="center" width="600"}
:::
...
## Sketch of Proof {full-screen=true}

<iframe width="100%" height="100%" data-external="1" src="https://miro.com/app/live-embed/uXjVMset0yw=/?moveToViewport=-669,-273,1081,630&embedId=545548756325" frameborder="0" scrolling="no" allow="fullscreen; clipboard-read; clipboard-write" allowfullscreen></iframe>
...
- Reconstruction beyond manifolds
    ...
    - (Ongoing with Rafal Komendaczyk, Tulane University)
