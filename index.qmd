...
- When the homology of $\mathcal{R}_\beta(X)$ is <green>finitely</green> generated?
- Alternative to the <green>Nerve Lemma</green> for Vietoris--Rips complexes
- Implications to <green>Shape Reconstruction</green>
...
## Hausdorff and Gromov--Hausdorff Distances  {.smaller}
